...
class ReinforceTrainer:
    ...
    def __init__(self, cfg: TrainConfig):
        ...
        # ------------------------------------------------------------------
        # rollout store – clear previous runs
        # ------------------------------------------------------------------
        rollout_dir = Path("rollouts")
        if rollout_dir.exists():
            shutil.rmtree(rollout_dir)
        self.rollout_store = RolloutStore(rollout_dir)
    ...
    def train(self):
        ...
        for episode in tqdm(range(cfg.num_episodes), desc="training episodes"):
            # ------------------------------------------------------------------
            # sample a batch of prompts (cycling through the dataset if needed)
            # ------------------------------------------------------------------
            prompts: List[Dict] = []
